...
int main()
{
	...
	cout << "root is: " << rbtree.get_root()->key << endl;
	rbtree.insert_key(15);

	cout << "root is: " << rbtree.get_root()->key << endl;
	rbtree.insert_key(70);

	cout << "root is: " << rbtree.get_root()->key << endl;
	rbtree.insert_key(20);

	cout << "root is: " << rbtree.get_root()->key << endl;
	rbtree.insert_key(60);

	cout << "root is: " << rbtree.get_root()->key << endl;
	rbtree.insert_key(30);
	rbtree.insert_key(50);
	rbtree.insert_key(65);
	rbtree.insert_key(80);
	rbtree.insert_key(90);
	rbtree.insert_key(40);
	rbtree.insert_key(5);
	rbtree.insert_key(55);
	cout << "root is: " << rbtree.get_root()->key << endl;
